	...
	function getSwitchOutput( style, environment ) {
		...
		switch ( style ) {
			case 'a-retired':
				...
				break;
			case 'a':
				var sandbox_name = 'Sandbox';
				if ( 'sandbox' === environment ) {
					output = '<div class="switch-a" data-checked="true"><span class="env" title="Your public website">Live site</span> <label class="switch"><input type="checkbox" checked data-live="'+live_home+'wp-admin/" data-sandbox="'+sandbox_home+'wp-admin/"><div class="slider round"></div></label> <span class="env" title="Your private website for testing and learning">'+sandbox_name+' site</span></div>';
				} else {
					output = '<div class="switch-a" data-checked="false"><span class="env" title="Your public website">Live site</span> <label class="switch"><input type="checkbox" data-live="'+live_home+'wp-admin/" data-sandbox="'+sandbox_home+'wp-admin/"><div class="slider round"></div></label> <span class="env" title="Your private website for testing and learning">Go to '+sandbox_name+' site</span></div>';
				}
				break;
			case 'b':
				var sandbox_name = 'Sandbox';
				if ( 'sandbox' === environment ) {
					...
					output = '<div class="switch-a" data-checked="false"><span class="env" title="Your public website">Live site</span> <label class="switch"><input type="checkbox" data-live="'+live_home+'wp-admin/" data-sandbox="'+sandbox_home+'wp-admin/"><div class="slider round"></div></label> <span class="env" title="Your private website for testing and learning">Go to the '+sandbox_name+' site</span></div>';
				}
				break;
			case 'c':
				var sandbox_name = 'Sandbox';
			...
			case 'd':
				...
				if ( 'sandbox' === environment ) {
					...
					output = '<div class="switch-a" data-checked="false"><span class="env" title="Your public website">Live site</span> <label class="switch"><input type="checkbox" data-live="'+live_home+'wp-admin/" data-sandbox="'+sandbox_home+'wp-admin/"><div class="slider round"></div></label> <span class="env" title="Your private website for testing and learning">'+sandbox_name+' site</span></div>';
				}
				break;
			case 'd-retired':
				if ( 'sandbox' === environment ) {
					output = '<div class="switch-z switch-button"><input class="switch-button-checkbox" type="checkbox" data-live="'+live_home+'wp-admin/" data-sandbox="'+sandbox_home+'wp-admin/" checked></input><label class="switch-button-label" for=""><span class="switch-button-label-span">Live Site</span></label></div>';
				} else {
					output = '<div class="switch-z switch-button"><input class="switch-button-checkbox" type="checkbox" data-live="'+live_home+'wp-admin/" data-sandbox="'+sandbox_home+'wp-admin/"></input><label class="switch-button-label" for=""><span class="switch-button-label-span">Live Site</span></label></div>';
				}
				break;
			default:
				break;
